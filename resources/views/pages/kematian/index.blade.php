...
<div class="row">
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <h6 class="card-title">Catatan Kematian Warga Margalaksana 09</h6>
        <a class="btn btn-primary mb-3" href="{{ route('catatan-kematian.create') }}" role="button">Tambah Data</a>
                ...
                <td>
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                      ...
                      <a class="dropdown-item d-flex align-items-center" href="{{ route('catatan-kematian.show', $data->id) }}"><i data-feather="eye" class="icon-sm me-2"></i> <span class="">View Detail</span></a>
