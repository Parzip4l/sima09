...
<div class="button-wrap">
    <div class="container">
        <a href="{{ route('catatan-kematian.create') }}" class="btn btn-primary w-100 mt-3">Buat Laporan Kematian</a>
    </div>
</div>
        ...
        <div class="d-md-block col-md-12 col-xl-12 mt-3">
            <div class="card rounded">
                <div class="card-header">
                    <h6 class="text-center">Data Kematian Tahun {{ date('Y')}}</h6>
                </div>
                <div class="card-body">
