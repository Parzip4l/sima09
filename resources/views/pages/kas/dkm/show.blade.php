...
<nav class="page-breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="#">Kas DKM</a></li>
...
<div class="row">
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <h6 class="card-title">Detail Kas Masjid AL-AMIN Tanggal {{$data->tanggal}}</h6>
        @if (session('error'))
        ...
        @endif
          ...
          <a href="{{ url('/kasdkm')}}" class="btn btn-primary">Kembali</a>
      </div>
    </div>
  </div>
</div>
