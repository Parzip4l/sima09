<nav class="sidebar">
  ...
  <div class="sidebar-body">
    <ul class="nav">
      ...
      <li class="nav-item {{ active_class(['capil/*']) }}">
        <a class="nav-link" data-bs-toggle="collapse" href="#capil" role="button" aria-expanded="{{ is_active_route(['capil/*']) }}" aria-controls="capil">
          <i class="link-icon" data-feather="file-text"></i>
          <span class="link-title">Kependudukan</span>
          <i class="link-arrow" data-feather="chevron-down"></i>
        </a>
        <div class="collapse {{ show_class(['capil/*']) }}" id="capil">
          <ul class="nav sub-menu">
            <li class="nav-item">
              <a href="{{ url('/catatan-kelahiran') }}" class="nav-link {{ active_class(['catatan-kelahiran']) }}">Catatan Kelahiran</a>
            </li>
            <li class="nav-item">
              <a href="{{ url('/catatan-kematian') }}" class="nav-link {{ active_class(['catatan-kematian']) }}">Catatan Kematian</a>
            </li>
            <li class="nav-item">
              <a href="{{ url('/kas-tarka') }}" class="nav-link {{ active_class(['kas-tarka']) }}">Permohonan Izin</a>
            </li>
            <li class="nav-item">
              <a href="{{ url('/kas-damar') }}" class="nav-link {{ active_class(['kas-damar']) }}">Surat Pendukung</a>
            </li>
          </ul>
        </div>
      </li>
      ...
      <li class="nav-item {{ active_class(['iuran']) }}">
        <a href="{{ url('/iuran') }}" class="nav-link">
          <i class="link-icon" data-feather="credit-card"></i>
          <span class="link-title">Iuran Warga</span>
        </a>
      </li>
      ...
      <li class="nav-item {{ active_class(['kas/*']) }}">
        <a class="nav-link" data-bs-toggle="collapse" href="#kas" role="button" aria-expanded="{{ is_active_route(['kas/*']) }}" aria-controls="kas">
          <i class="link-icon" data-feather="file-text"></i>
          <span class="link-title">KAS</span>
          <i class="link-arrow" data-feather="chevron-down"></i>
        </a>
        <div class="collapse {{ show_class(['kas/*']) }}" id="kas">
          <ul class="nav sub-menu">
            <li class="nav-item">
              <a href="{{ url('/kas') }}" class="nav-link {{ active_class(['kas']) }}">KAS RW</a>
            </li>
            <li class="nav-item">
              <a href="{{ url('/kasdkm') }}" class="nav-link {{ active_class(['kasdkm']) }}">KAS DKM</a>
            </li>
            <li class="nav-item">
              <a href="{{ url('/kaskarta') }}" class="nav-link {{ active_class(['kaskarta']) }}">KAS Karang Taruna</a>
            </li>
            <li class="nav-item">
              <a href="{{ url('/kasdamar') }}" class="nav-link {{ active_class(['kasdamar']) }}">KAS TPU Damar</a>
            </li>
          </ul>
        </div>
      </li>
      ...
      <li class="nav-item {{ active_class(['apps/calendar']) }}">
        <a href="{{ url('apps/calendar') }}" class="nav-link">
        <i class="link-icon" data-feather="calendar"></i>
          <span class="link-title">Jadwal Kegiatan</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['bannersetting']) }}">
        <a href="{{ url('/bannersetting') }}" class="nav-link">
        <i class="link-icon" data-feather="layers"></i>
          <span class="link-title">Banner Informasi</span>
        </a>
      </li>
      ...
      <li class="nav-item {{ active_class(['reports/*']) }}">
        ...
        <div class="collapse {{ show_class(['reports/*']) }}" id="reports">
          <ul class="nav sub-menu">
            <li class="nav-item">
              <a href="{{ url('/ceklaporanzakat') }}" class="nav-link {{ active_class(['ceklaporanzakat']) }}">Zakat</a>
            </li>
          </ul>
        </div>
      </li>
      <li class="nav-item nav-category">Settings</li>
      <li class="nav-item {{ active_class(['wilayah']) }}">
